...
// TODO: a function that extracts the values from the json object to be injected in the container later
}
...
async function index (req, res) {
    const Attributes = await this.attributesextractor.getAttributes()

    res.render('main', {Attributes})
}
